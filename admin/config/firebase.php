            ...
            <div class="card-body">
                <form method="POST">
                    ...
                    <div class="form-group text-right">
                        ...
                        <button type="submit" name="disablefirebase" class="btn btn-warning waves-effect waves-light">Disable</button>
                        <button type="submit" name="savefirebase" class="btn btn-primary waves-effect waves-light">Submit</button>
                    </div>
                </form>
            </div>
        </div>
