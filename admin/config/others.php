                ...
                <form method="POST" id="ReloadThisFeatureShenn">
                    <fieldset>
                        <div class="custom-control custom-checkbox mb-2">
                            <input class="custom-control-input" id="cfg_8" type="checkbox" name="xtra_fitur" value="undangandigital" <?= (conf('xtra-fitur', 8) == 'true') ? 'checked' : '' ?>>
                            <label class="custom-control-label" for="cfg_8">
                               Transaksi - undangandigital
                            </label>
                        </div>
                    </fieldset>
                    <fieldset>
