...
<form method="POST" id="form-edit">
    ...
    <div class="row">
        ...
        <div class="form-group col-6">
            <button type="button" onclick="ShennAct('#form-edit','<?= base_url('admin/pulsa-ppob/transaction-edit?s='.$code) ?>');" class="btn btn-primary btn-block"> EDIT </button>
        </div>
    </div>
</form>
<?php
