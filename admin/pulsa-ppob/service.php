                ...
                <div class="card-header d-flex justify-content-between">
                    ...
                    <div class="dropdown chart-dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownItem2">
                          <a class="dropdown-item" href="javascript:;" <?= onclick_modal('Clear Service', base_url('admin/pulsa-ppob/service-add'), 'lg') ?>>Add Once</a>
                          <a class="dropdown-item" href="javascript:;" <?= onclick_modal('Clear Service', base_url('admin/pulsa-ppob/service-clear'), 'md') ?>>Clear</a>
                        </div>
                    </div>
                </div>
...
<?= datatable(['url' => ajaxlib('table/service?__s=1'),'sort' => 4,'type' => 'asc']) ?>