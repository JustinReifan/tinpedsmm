                ...
                <div class="card-header d-flex justify-content-between">
                    ...
                    <div class="dropdown chart-dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownItem2">
                          <a class="dropdown-item" href="javascript:;" <?= onclick_modal('Add Category', base_url('admin/pulsa-ppob/category-add'), 'lg') ?>>Add Once</a>
                          <a class="dropdown-item" href="javascript:;" <?= onclick_modal('Clear Category', base_url('admin/pulsa-ppob/category-clear'), 'md') ?>>Clear All</a>
                        </div>
                    </div>
                </div>
...
<?= datatable(['url' => ajaxlib('table/category?__s=1'),'sort' => 1,'type' => 'asc']) ?>