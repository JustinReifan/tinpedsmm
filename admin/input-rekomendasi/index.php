        ...
        <div class="col-12">
            <div class="card overflow-hidden">
                <div class="card-header">
                    <h4 class="card-title">Input Rekomendasi Layanan</h4>
                </div>
                <div class="card-body card-dashboard">
                    <ul class="nav nav-tabs" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" id="ShennAdd-tab" data-toggle="tab" href="#ShennAdd" aria-controls="ShennAdd" role="tab" aria-selected="false">New Input Layanan</a>
                        </li>
                    </ul>
                    <div class="tab-content">
                        ...
                        <div class="tab-pane" id="ShennAdd" aria-labelledby="ShennAdd-tab" role="tabpanel">
                            <form method="POST">
                                ...
                                <div class="form-group">
                                    <label>Answer</label>
                                    <textarea style="width:100%;" name="addfaq_ans"></textarea>
                                </div>
                                <div class="form-group text-right">
                                    <button type="submit" name="reset" class="btn btn-danger waves-effect waves-light">Reset</button>
                                    <button type="submit" name="addrekomendasi" class="btn btn-primary waves-effect waves-light">Submit</button>
                                </div>
                            </form>
                        </div>
                    </div>
...
<?= datatable(['url' => ajaxlib('table/news?__s=5'),'sort' => 2,'type' => 'desc']) ?>