...
if (!empty($_SERVER['HTTP_X_REQUESTED_WITH']) && strtolower($_SERVER['HTTP_X_REQUESTED_WITH']) == 'xmlhttprequest' && isset($data_user)) {
    ...
    $res = ShennCheck($code, $data['userid'], $data['apikey'], $data['secretkey']);
?>
    <form method="POST">
        <?php if ($res['type'] == true) { ?>
            <div class="alert bg-gradient-primary text-white border-0" style="border-radius:5px" role="alert">
        ...
        <?php } else if ($res['type'] == false) { ?>
            <div class="alert bg-gradient-danger text-white border-0" style="border-radius:5px" role="alert">
