...
require _DIR_('library/shennboku.app/adminahhsahahashjshjshajhajhxbbhdasxbhxbhhdswah.php');
?>
<style>
...
<div class="row justify-content-center">
    <div class="col-12 col-lg-10 col-xl-9">
            <a href="/" style="color:#1E1E1E !important;">
                <b><i class="fas fa-chevron-circle-left"></i></b> Kembali ke Halaman Sebelumnya
            </a>
        </div>
    </div>
    <br>
                    ...
                    <div class="card-header">
                        <div class="invoice-header">
                            ...
                            <div class="invoice-logo">
                                <img src="<?= $_CONFIG['icon']; ?>" style="width: 50% !important;" alt="">
                            </div>
                        </div>
                            ...
                            <div class="col-md-12">
                                <div class="invoice-detail">
                                    <div class="invoice-top">
                                        <h3 class="title"><strong>Ringkasan Deposit</strong></h3>
                                    </div>
                                            ...
                                            <table class="table table-striped">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <td class="text-center"><strong>Pembayaran</strong></td>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td></td>
                                                        <td class="text-center"><strong>Unik</strong></td>
                    ...
                    <div class="card-footer">
                        <div class="row">
                            <div class="col-sm-7 col-md-5 mb-3 mb-md-0 transfer-to">
                                ...
                                <div class="account-transfer text-left font-weight-bold">
                                    <div class="font-weight-bold">
                                        <p>Pembayaran : <?= $payname ?></p>
                                    </div>
                                     
                                    <div class=" text-left">
                                        <p>Nama Tujuan :  
                                          <?php if (filter_var($rowvoice['note'], FILTER_VALIDATE_URL)): ?>
                                        <?php else: ?>
                                      <p class="text-danger font-weight-bold text-md" style="font-size:16px;"><?= explode(' A/n ',$rowvoice['note'])[1] ?></p></p>
                                    <p>Nomor Tujuan : <p class="text-danger font-weight-bold text-md" style="font-size:16px;"><?= explode(' A/n ',$rowvoice['note'])[0] ?></p></p>
                                         <?php endif ?>
                                    </div>
                                      ...
                                      <div class="mb-1 text-left">
                                          ...
                                          <div class="mb-1">
                                             <span>Lanjutkan Pembayaran </span>
                                                <a href="<?= explode(' A/n ',$rowvoice['note'])[0] ?>" target="_blank" class="btn btn-md btn-relief-warning btn-block btn-inline waves-effect waves-light" style="style="font-size: 13px !important;font-weight: 600;">Bayar Sekarang</a>
                                          </div>
                                         <?php else: ?>
