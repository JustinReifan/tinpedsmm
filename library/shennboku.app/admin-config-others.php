...
if(isset($_GET['feature']) && $_POST) {
    $val = strtr($_POST['value'],['trxpostpaid'=>'c1','trxgame'=>'c2','trxsocmed'=>'c3','hofpage'=>'c4','ssodevice'=>'c5','reqlocfwa'=>'c6','devmode'=>'c7','undangandigital'=>'c8']);
    ...
    } else if(!in_array($val,['c1','c2','c3','c4','c5','c6','c7','c8'])) {
