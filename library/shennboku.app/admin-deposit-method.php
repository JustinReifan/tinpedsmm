...
if(isset($_POST['method_add'])) {
    ...
    if($result_csrf == false) {
        ...
        if($call->query("INSERT INTO deposit_method VALUES (null,'$post_1','$post_2','$post_data','$post_7','$post_6','$post_5','$post_8','$post_type','$post_9')") == true) {
    ...
    if($result_csrf == false) {
        ...
        if($call->query("UPDATE deposit_method SET method = '$post_1', name = '$post_2', data = '$post_data', rate = $post_7, fee = $post_6, xfee = '$post_5', min = $post_8, type = '$post_type', auto = $post_9 WHERE id = '$web_token'") == true) {
