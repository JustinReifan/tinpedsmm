...
$search = $call->query("SELECT * FROM trx_socmed WHERE status IN ('waiting','processing','') AND provider = 'MEDANPEDIA' AND DATE(date_cr) BETWEEN '$stdate' AND '$date' ORDER BY rand() LIMIT 1");
