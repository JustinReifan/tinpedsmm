                        ...
                        <ul class="nav navbar-nav float-right">
                            ...
                            <li class="dropdown dropdown-notification nav-item">
                                <a class="nav-link nav-link-label" href="#" data-toggle="dropdown">
                                    <i class="ficon feather icon-bell info"></i>
                                </a>
                              ...
                              <?php $getPesan = $call->query("SELECT * FROM tiket WHERE user = '".$data_user['username']."' AND status = 'Responded'"); ?>
                            ...
                            <li class="dropdown dropdown-notification nav-item">
                            <a class="nav-link nav-link-label" href="<?= base_url('tiket/index') ?>" data-toggle="">
                            <i class="ficon feather icon-message-square"></i>
                            <span class="badge badge-warning badge-pill" style="padding: 0.42em 0.6em 0.25rem; position: relative; right: 22px; top: -12px; background-color: #e90036;"><?= $jumlahPesan ?></span>
                            </a>
                            </li>
                            <li class="dropdown dropdown-user nav-item">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a class="dropdown-item" href="<?= base_url('account/profile') ?>"><i class="feather icon-user primary"></i>Profile</a>
                                    <!--<a class="dropdown-item" href="<?= base_url('account/notification') ?>"><i class="feather icon-bell info"></i> Notifications</a>-->
                                    <a class="dropdown-item" href="<?= base_url('account/signin-access') ?>"><i class="feather icon-layers warning"></i> Sign Access</a>
                                    <!--<a class="dropdown-item" href="<?= base_url('account/mutation') ?>"><i class="far fa-credit-card success"></i> Mutasi Saldo</a>-->
                                    <a class="dropdown-item" href="<?= base_url('account/activity') ?>"><i class="feather icon-check-square primary"></i> Log</a>
                                    <div class="dropdown-divider"></div>
                                    <a class="dropdown-item" href="<?= base_url('auth/logout') ?>"><i class="feather icon-power danger"></i> Logout</a>
                                </div>
                            </li>
                        </ul>
                        <? } ?>
